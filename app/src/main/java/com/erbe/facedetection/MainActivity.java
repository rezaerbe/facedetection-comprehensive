package com.erbe.facedetection;
...
import com.erbe.facedetection.Adapter.FaceDetectionAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<FaceDetection> faceDetections;
...
//        });
        ...
        bottomSheetRecyclerView.setAdapter(new FaceDetectionAdapter(this, faceDetections));
    }
    ...
    private void detectFaces(List<FirebaseVisionFace> firebaseVisionFaces, Bitmap bitmap) {
        ...
        for (int i = 0; i < firebaseVisionFaces.size(); i++) {
            ...
            faceDetections.add(new FaceDetection(i, "Smiling Probability " + face.getSmilingProbability()));
            faceDetections.add(new FaceDetection(i, "Left Eye Open Probability " + face.getLeftEyeOpenProbability()));
            faceDetections.add(new FaceDetection(i, "Right Eye Open Probability " + face.getRightEyeOpenProbability()));
